...
class Header extends Component {
    ...
    render() {  
        ...
        <React.Fragment>
            ...
            <div className="container">
                <div className="header-top">
                    ...
                    <a href="JavaScript:void(0)" class="link-head" data-toggle="modal" data-target="#signup" onClick={this.toggle}>Login</a>
        ...
        <button type="button" class="close" data-dismiss="modal" onClick={() => this.toggle(false)}>&times;</button>
            ...
            <div className="popup-content">
                ...
                <form className="row">
                    ...
                    <div className="form-group col-sm-12">
                        ...
                        <span className="already" >Already registered? <a href="JavaScript:void(0)" data-toggle="modal" data-target="#signin" className="green" data-dismiss="modal" onClick={()=> {this.toggle(false) ; this.onLoginClick()}} > <ModalExample ref= {this.loginModalRef}></ModalExample> Sign in</a></span>   
                    </div>
                </form>
            </div>
           </div>
